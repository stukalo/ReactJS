...
var open = require('gulp-open'); //open a url a web browser
var browserify = require('browserify');//open a url in a web browser
...
gulp.task('js', function(){
    browserify(config.paths.mainJs).transform(reactify)
        ...
        .pipe(source('bundle.js')).pipe(gulp.dest(config.paths.dist + '/scripts'))
        .pipe(connect.reload());
});
